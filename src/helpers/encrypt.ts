...
export default async function encrypt(data: string, password: string) {
...
async function encryptData(secretData: any, password: any) {
  try {
...
async function decryptData(encryptedData: any, password: any) {
  try {
